...
public class RegisterproviderTest {
  ...
  public void registerprovider() {
    driver.get("http://localhost:8000/provider/register");
    ...
    driver.findElement(By.id("email")).sendKeys("email2@email.com");
    driver.findElement(By.id("password")).click();
    driver.findElement(By.id("password")).sendKeys("passwordf");
    driver.findElement(By.id("matchingPassword")).click();
    driver.findElement(By.id("matchingPassword")).sendKeys("passwordf");
